...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Tools of Trade: load initial list and wire filter selects.
    loadTools();
    document.getElementById('tools-filter-status').addEventListener('change', loadTools);
    document.getElementById('tools-filter-type').addEventListener('change', loadTools);
});
