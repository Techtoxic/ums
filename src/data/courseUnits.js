...
const courseUnits = {
    ...
    'applied_biology_6': {
        ...
        level: 6,
        units: [
            { unitCode: 'AB6-001', unitName: 'Demonstrate Communication Skills' },
            { unitCode: 'AB6-002', unitName: 'Demonstrate Numeracy Skills' },
            { unitCode: 'AB6-003', unitName: 'Demonstrate Digital Literacy' },
            { unitCode: 'AB6-004', unitName: 'Demonstrate Entrepreneural Skills' },
            { unitCode: 'AB6-005', unitName: 'Demonstrate Employability Skills' },
            { unitCode: 'AB6-006', unitName: 'Demonstrate Environmental Literacy' },
            { unitCode: 'AB6-007', unitName: 'Demonstrate Occupational Safety and Health Practices' },
            { unitCode: 'AB6-008', unitName: 'Perform Anatomy and Physiology Studies' },
            { unitCode: 'AB6-009', unitName: 'Apply Standard Laboratory Practice' },
            { unitCode: 'AB6-010', unitName: 'Carry out Microscopy' },
            { unitCode: 'AB6-011', unitName: 'Conduct Laboratory Research' },
            { unitCode: 'AB6-012', unitName: 'Carry out Cytological and Histological Techniques' },
            { unitCode: 'AB6-013', unitName: 'Carry out Microbiological Techniques' },
            { unitCode: 'AB6-014', unitName: 'Perform Taxonomic Studies' },
            { unitCode: 'AB6-015', unitName: 'Apply Herbarium Museum, Aquarium and Vivarium Techniques' },
            { unitCode: 'AB6-016', unitName: 'Carry out Ecological and Soil Studies' },
            { unitCode: 'AB6-017', unitName: 'Carry out Animal Husbandry' },
            { unitCode: 'AB6-018', unitName: 'Carry out Plant Husbandry' },
            { unitCode: 'AB6-019', unitName: 'Apply Entomology Techniques' },
            { unitCode: 'AB6-020', unitName: 'Carry out Parasitological Techniques' },
            { unitCode: 'AB6-021', unitName: 'Perform Imminological Techniques' },
            { unitCode: 'AB6-022', unitName: 'Apply Biochemical Techniques' },
            { unitCode: 'AB6-023', unitName: 'Perform Pharmacological and Toxicological Techniques' }
        ]
    },
