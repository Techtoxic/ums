...
const graduationApplicationSchema = new mongoose.Schema({
...
graduationApplicationSchema.index({ studentId: 1, academicYear: 1 }, { unique: true });
graduationApplicationSchema.index({ status: 1, applicationDate: -1 });
graduationApplicationSchema.index({ department: 1, status: 1 });
...
graduationApplicationSchema.statics.canStudentApply = function(level, yearOfStudy) {
...
module.exports = mongoose.model('GraduationApplication', graduationApplicationSchema);