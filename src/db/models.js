...
const AttachmentApplication    = makeModel(schema.attachmentApplications, { fieldMap: { studentId: 'student_id', companyName: 'company_name', startDate: 'start_date', endDate: 'end_date' } });
const GraduationApplication    = makeModel(schema.graduationApplications, { fieldMap: { studentId: 'student_id', appliedAt: 'applied_at', approvedAt: 'approved_at', approvedBy: 'approved_by' } });
